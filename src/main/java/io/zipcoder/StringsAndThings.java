...
public class StringsAndThings {
    ...
    public Integer countYZ(String input) {
        ...
        if (input.charAt(length - 1) == 'y' || input.charAt(length - 1) == 'z') {
            count++;
        }

        for (int i = 0; i < length - 1; i++) {
            if (input.charAt(i) == ' ' && ((input.charAt(i - 1) == 'y') || input.charAt(i - 1) == 'z')) {
                count += 1;
            }
            ...
            if (input.charAt(i) == 'g') {
             ...
             //   } else if (input.charAt(i)) == 'g' && input.charAt(i +1) != {
                ...
                public Integer countTriple (String input){
                    Integer count = 0;
                    for (int i = 0; i < input.length() - 2; i++) { //remember to use -2 because we are looking for triplets and we will bleed over with -1
